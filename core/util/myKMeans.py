...
class fast_KMeans:
    def __init__(self, n_clusters=8, n_init=1, max_iter=300, gpu=False, n_threads=24, KKZinit=True):
...
class myKMeans():
    def __init__(self, n_clusters=-1, trunc=-1, fast=False, gpu=False, n_threads=24, sort=True, saveObj=False, KKZinit=True):
        if fast == True:
